...
@implementation KJSearchHistoryCell
...
- (void)_setup{
    self.contentView.backgroundColor = UIColorFromHEXA(0x333333,0.1);
...
- (void)_setupSubViews{
    ...
    titleLabel.font = KJRegularFont_12;
...
- (void)_makeSubViewsConstraints{
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make){
        make.edges.mas_equalTo(UIEdgeInsetsZero);  // 父视图尺寸
    }];
}
@end
