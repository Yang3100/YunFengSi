...
@interface KJSearchHistoryHeaderView ()
/// titleLabel
...
@implementation KJSearchHistoryHeaderView
...
- (void)_setupSubViews{
    ...
    titleLabel.font = KJRegularFont_13;
    titleLabel.textColor = UIColorHexFromRGB(0x333333);
    ...
    [deleteBtn setImage:GetImage(@"delect_gragy")forState:UIControlStateNormal];
