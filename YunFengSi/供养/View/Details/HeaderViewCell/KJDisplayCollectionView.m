...
//        HNUserVipPriceListModel  *listModel = self.comboArray[indexPath.row];
//        NSString  *string = [NSString stringWithFormat:@"%.2f",[listModel.combo_fee doubleValue]];
//        [self setPriceLabText:string];
//        self.selectModel = listModel;
}
#pragma mark - getter
